...
uv run python -m qa test backend              # Run backend tests (962)
...
- **Tests**: `tests/` — 962 backend tests + 224 E2E Playwright tests
...
- Progress tracker: `docs/progress.md` (M0-M255 complete)
