...
## Technical Details
- **Registry:** `frontend/src/data/architecture/index.ts` — 129 sections across 26 views + app layout
- **Maturity Distribution (Current):** 74 fully-metadata-driven (57%), 35 mostly-metadata-driven (27%), 6 mixed (5%), 5 code-driven (4%), 8 infrastructure (6%) — **85% metadata-driven** overall
