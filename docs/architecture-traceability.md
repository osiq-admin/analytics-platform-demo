...
- **Maturity Distribution (M256):** 51 fully-metadata-driven (51%), 30 mostly-metadata-driven (30%), 6 mixed (6%), 5 code-driven (5%), 8 infrastructure (8%) — **81% metadata-driven** overall
