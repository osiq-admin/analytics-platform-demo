...
**Started**: 2026-02-23
**Last Updated**: 2026-03-03 (M378 Phase 22b Cross-View Governance; 1813 total tests: 1517 backend + 296 E2E, 26 views, 40 scenarios, 129 architecture sections, 1093 modules)
...
| Cross-View PII Governance (Phase 22b) | IN PROGRESS | M369-M378: Cross-view masking enforcement (GDPR Art. 25), PII access audit (MAR Art. 16), PII registry API, frontend indicators — 1813 tests (1517 backend + 296 E2E) |
...
| M374 | Frontend governance store + PiiBadge | IN PROGRESS | 1 | - | governanceStore piiRegistry, PiiBadge component, piiColumns utility |
| M375 | AppLayout integration + masking indicators | PENDING | 1 | - | PII registry fetch, masking count in toolbar |
| M376 | E2E Playwright tests | PENDING | 1 | - | Cross-view masking E2E tests |
| M377 | Compliance evidence + architecture registry | PENDING | 1 | - | compliance_matrix, bcbs239_mapping, BDD, demo guide |
| M378 | Tier 3 phase completion — full QA + merge | PENDING | 1 | - | Full QA, Playwright verification, doc sweep, merge |
