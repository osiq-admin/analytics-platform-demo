...
const S1_VIEW_SETTINGS: ScenarioDefinition = {
  ...
  steps: [
    ...
    {
      target: "[data-tour='settings-list'] .ag-body-viewport .ag-row[row-index='5']",
      ...
      action: "click",
      actionTarget:
        "[data-tour='settings-list'] .ag-body-viewport .ag-row[row-index='5']",
...
const S2_MODIFY_THRESHOLD: ScenarioDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      action: "click",
      actionTarget:
        "[data-tour='settings-list'] .ag-body-viewport .ag-row[row-index='10']",
...
const S3_PRODUCT_OVERRIDE: ScenarioDefinition = {
  ...
  steps: [
    ...
    {
      target: "[data-action='add-override']",
      ...
      placement: "bottom",
      action: "click",
      actionTarget: "[data-action='add-override']",
    ...
    {
      target: ".space-y-2 > div:last-child label:last-of-type input",
      ...
      action: "type",
      actionTarget:
        ".space-y-2 > div:last-child label:last-of-type input",
      actionValue: "0.025",
    ...
    {
      target: "[data-action='save-changes']",
      ...
      placement: "top",
      action: "click",
      actionTarget: "[data-action='save-changes']",
...
const S4_SCORE_STEPS: ScenarioDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      action: "click",
      actionTarget:
        "[data-tour='settings-list'] .ag-body-viewport .ag-row[row-index='3']",
    ...
    },
    {
      ...
      placement: "bottom",
      action: "click",
      actionTarget: "[data-action='add-tier']",
    ...
    {
      target: "[data-action='apply-template']",
...
const S5_MATCH_PATTERNS: ScenarioDefinition = {
  ...
  steps: [
    ...
    {
      target: "[data-action='pick-pattern']",
      ...
      placement: "bottom",
      action: "click",
      actionTarget: "[data-action='pick-pattern']",
    ...
    {
      target: "[data-action='apply-pattern']",
...
const S6_RESOLUTION_DEEP_DIVE: ScenarioDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      placement: "left",
      action: "click",
      actionTarget: "[data-tour='settings-resolver'] [data-action='resolve']",
...
export const settingsScenarios: Record<string, ScenarioDefinition> = {
